...
<section class="bg-gray-light py-5 fade-in-center">
 ...
 <div class="mt-5 animate-in">
 <h3 class="alt-h3 mt-3">📚 Other Teaching Events</h3>
 ...
 <img src="assets/img/EMP/Zambia.jpg" alt="Zambia Financial Modelling Workshop Group Photo" class="img-fluid rounded shadow-sm content-img-md">
 </p>
 </div>
 </div>
